    ...
    <div className="flex justify-center items-center py-10 lg:py-20 animate-fade-in-up">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm opacity-50 mt-2 font-medium">Google orqali xavfsiz tizimga kiring</p>
        </div>
        ...
        <div className="card bg-base-100 shadow-2xl border border-base-content/5 overflow-hidden">
          ...
          <div className="card-body p-8">
            ...
            <button
              ...
              disabled={pending}
            >
              {pending ? <span className="loading loading-spinner loading-sm"></span> : 'Google bilan kirish'}
            </button>
